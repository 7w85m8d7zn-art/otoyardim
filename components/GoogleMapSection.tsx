...
export function GoogleMapSection({
  title = "Google Harita ve Konum Bilgisi",
  description = "Yerel güven sinyallerini güçlendirmek için Ortaköy / Aksaray merkez bilgisini, çalışma saatlerini ve harita entegrasyonunu açık biçimde gösteriyoruz.",

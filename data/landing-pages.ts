...
const citySupportLinks: RelatedLink[] = [
  ...
  },
  {
    ...
    description: "Niğde Otobanı ve çevresindeki saha desteği sayfamıza bakın.",
  },
];
...
const servicePages: LandingPage[] = [
  {
    ...
    metaDescription:
      "Aksaray, Ortaköy ve Niğde Otobanı hattında 7/24 yol yardım, patlak lastik desteği, stepne değişimi ve mobil müdahale için Şen Oto Lastik'e ulaşın.",
    title: "Aksaray'da 7/24 Yol Yardım",
    eyebrow: "Yerel Hizmet SEO",
    badge: "Niğde Otobanı Dahil Hizmet",
    description:
    ...
    highlights: [
      ...
      "Niğde Otobanı dahil yakın hatlarda destek",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Ortaköy merkezli operasyon, Aksaray içi ve bağlantı yollarında daha hızlı rota kurulmasını sağlar. Uygun durumlarda Niğde Otobanı tarafındaki çağrılar da aynı hız mantığıyla planlanır.",
    ...
    relatedLinks: [...baseServiceLinks.slice(1), ...citySupportLinks],
  ...
  },
  {
    ...
    metaDescription:
      "Aksaray, Ortaköy ve Niğde Otobanı hattında mobil lastik servisi, yerinde sökme-takma, lastik değişimi ve acil yol yardımı için 7/24 ulaşın.",
    ...
    intro:
      "Mobil lastik servisi, özellikle yolda kalındığında ya da aracı hareket ettirmek riskli olduğunda en pratik çözümdür. Şen Oto Lastik; Ortaköy, Aksaray ve Niğde Otobanı hattında konuma gelerek lastik tamiri, değişimi ve acil müdahale desteği sağlar.",
    ...
    highlights: [
      ...
      "Niğde Otobanı'nda da hızlı değerlendirme",
    ...
    sections: [
      ...
      {
        title: "Aksaray ve otoban hattında pratik iletişim",
        paragraphs: [
    ...
    faqGroups: buildFaqGroups(
      ...
      "Uygun mesafedeki çağrılarda evet. Aksaray, Ortaköy ve Niğde Otobanı hattında telefon ile konum doğrulaması sonrası doğrudan bulunduğunuz noktaya gelinir.",
  ...
  },
  {
    ...
    metaDescription:
      "Aksaray, Ortaköy ve Niğde Otobanı hattında oto lastik tamiri, patlak lastik onarımı ve hava kaçağı için Şen Oto Lastik'e 7/24 ulaşın.",
    ...
    intro:
      "Her patlak lastik değişim gerektirmez. Uygun durumlarda tamir ile güvenli şekilde yola devam etmek mümkündür. Şen Oto Lastik, Aksaray, Ortaköy ve Niğde Otobanı hattında oto lastik tamiri taleplerinde duruma göre yerinde çözüm ya da güvenli yönlendirme sunar.",
  ...
  },
  {
    ...
    metaDescription:
      "Aksaray, Ortaköy ve Niğde Otobanı hattında yerinde lastik değişimi, stepne değişimi ve 7/24 mobil lastik desteği için Şen Oto Lastik'i arayın.",
    ...
    highlights: [
      ...
      "Niğde Otobanı dahil saha planı",
    ],
    ...
    sections: [
      ...
      {
        title: "Aksaray ve otoban geçişlerinde 7/24 destek",
        paragraphs: [
          "Ortaköy / Aksaray çıkışlı saha desteğimiz, merkez ve çevre bağlantı yollarında lastik değişimi ihtiyacını hızlı karşılamak için planlanır. Uygun rotada kalan Niğde Otobanı çağrıları da aynı sistem içinde değerlendirilir.",
        ],
      },
    ],
    faqGroups: buildFaqGroups(
  ...
  },
  {
    ...
    relatedLinks: [...baseServiceLinks, citySupportLinks[1], citySupportLinks[2]],
...
const citySeeds: CityPageSeed[] = [
  ...
  },
  {
    ...
    city: "Niğde",
    opening:
      "Niğde hattındaki kullanıcılar çoğunlukla şehirler arası yolda veya otoban geçişinde acil lastik desteği arar.",
    routeDetail:
      "Niğde yol yardım sayfasında özellikle Niğde Otobanı'nda full hizmet verdiğimizi, stepne değişimi ve patlak lastik desteğini öne çıkarıyoruz.",
    note:
      "Niğde Otobanı ve yakın bölgelerdeki taleplerde çağrı uygunluğu rota ve anlık yoğunluğa göre netleşir. İlk aramada açık lokasyon bilgisi verilmesi müdahale hızını ciddi şekilde artırır.",
...
const cityPages: LandingPage[] = citySeeds.map((seed) => ({
  ...
  relatedLinks: [...baseServiceLinks, citySupportLinks[0], citySupportLinks[1]],
